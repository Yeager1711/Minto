            ...
            <section className={styles.job + ' marTop'}>
                  ...
                  <section className={styles['job-container']}>
                        <div className={styles['header-searchByCriteria']}>
                              <h3>
                                    <p>99 Việc làm phù hợp</p> Tất cả
                              </h3>
                        </div>
                        ...
                        <div className={styles['filter-searchByCriteria']}>
                              ...
                              <div className={styles['filter']}>
                                    ...
                                    <span className={styles['ant-input-number-group-addon']}>
                                          VNĐ
                                    </span>
                              </div>
                              ...
                              {jobData.map((item) => (
                                    <div className={styles['box']} key={item.jobId}>
                                          ...
                                          <div className={styles['company-logo']}>
                                                <img
                                                      src={item.company.images[0]?.image_company}
                                          ...
                                          <div className={styles['info']}>
                                                ...
                                                <div className={styles['Salary-Negotiable']}>
                                                      Lương:
                                                      <p className={styles['Salary-from']}>
                                                            {' '}
                                                            {item.salary_from}
                                                      </p>
                                                      -
                                                      <p className={styles['Salary-to']}>
                                                            {item.salary_to}Tr
                                                      </p>
                                                </div>
