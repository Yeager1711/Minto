...
function Home() {
    ...
    const [jobSearch, setJobSearch] = useState<Job[]>([]);
    ...
    const jobsToDisplay = filteredJobsType.length > 0 ? filteredJobsType : jobSearch;
    ...
    const handleSearchJobType = () => {
        const filtered = jobSearch.filter((job) => {
        ...
        <div className={styles.Home}>
            ...
            <section className={styles['wrapper-home']}>
                ...
                <div className={styles['wrapper-container']}>
                    ...
                    >
                        {Array.from(new Map(jobSearch.map((job) => [job.company.name, job])).values()).map(
                            (company) => (
                    ...
                    <div className={styles.list__item}>
                        <div className={styles.header}>
                            ...
                            <select onChange={handleIndustryChange}>
                                ...
                                <option value="Quảng Cáo Truyền Thông, Sale & Marketing Services">Quảng Cáo Truyền Thông, Sale & Marketing Services</option>
                            </select>
