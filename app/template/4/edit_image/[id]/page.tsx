...
interface Images {
    ...
    footerImage1: { url: string; position: string; fileName?: string };
    footerImage2: { url: string; position: string; fileName?: string };
}
...
function Template4Edit() {
    ...
    const fileInputRefs = {
        ...
        footerImage1: useRef<HTMLInputElement>(null),
        footerImage2: useRef<HTMLInputElement>(null),
    };
    ...
    useEffect(() => {
        ...
        const updateCountdown = () => {
            const now = new Date(); // Current date and time: 02:00 PM +07, Saturday, June 14, 2025
            const weddingDateTime = weddingData.weddingDate
                ...
                : new Date(2025, 11, 23, 11, 0, 0); // Default to Dec 23, 2025, 11:00 AM
        ...
        <Suspense fallback={<div>Loading...</div>}>
            <div className={styles.template4}>
                ...
                <div className={styles.mainImage} data-aos="fade-down">
                    <Image
                        src={images.mainImage.url || '/placeholder-image.png'}
                    ...
                    <div className={styles.torn_paper__header}>
                        <Image src="/images/m4/1.1.png" alt="Torn paper decoration" width={600} height={100} />
                    </div>
                </div>
                ...
                <div className={styles.footer} data-aos="fade-up" data-aos-delay="1400">
                    ...
                    <div className={styles.show_receivedQR}></div>
                </div>
                <div className={styles.footer_image}>
                    <div className={styles.image_f1}>
                        <Image
                            src={images.footerImage1.url || '/placeholder-image.png'}
                            alt={images.footerImage1.url ? 'Ảnh chân trang 1' : 'Chọn ảnh'}
                            width={300}
                            height={200}
                            onClick={() => triggerFileInput('footerImage1')}
                            className={images.footerImage1.url ? '' : styles.imagePlaceholder}
                            style={{ cursor: 'pointer' }}
                        />
                        <input
                            type="file"
                            ref={fileInputRefs.footerImage1}
                            onChange={(e) => handleImageChange('footerImage1', 'footer1', e)}
                            accept="image/*"
                            style={{ display: 'none' }}
                        />
                    </div>
                    <div className={styles.image_f2}>
                        <Image
                            src={images.footerImage2.url || '/placeholder-image.png'}
                            alt={images.footerImage2.url ? 'Ảnh chân trang 2' : 'Chọn ảnh'}
                            width={300}
                            height={200}
                            onClick={() => triggerFileInput('footerImage2')}
                            className={images.footerImage2.url ? '' : styles.imagePlaceholder}
                            style={{ cursor: 'pointer' }}
                        />
                        <input
                            type="file"
                            ref={fileInputRefs.footerImage2}
                            onChange={(e) => handleImageChange('footerImage2', 'footer2', e)}
                            accept="image/*"
                            style={{ display: 'none' }}
                        />
                    </div>
